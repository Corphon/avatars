...
description: >
  ...
  user intents should be dispatched to script, edit, run, or plan mode,
...
context: Governs how avatars routes user requests to the correct execution path: script, edit, run, or plan mode.
version: 0.1.0
...
Route here when the user asks to **build, implement, or create a multi-file project**.
This is the primary path for code generation. For new projects: `go mod init <name> && avatars run "<task>"`.
Bootstrap is deprecated — do NOT suggest it.
